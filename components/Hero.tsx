export default function Hero() {
  return (
    <>
      <section className="h-screen flex items-center bg-hero bg-cover">
        <div className="container flex justify-between flex-col mx-auto">
          <h1 className="max-w-7xl text-8xl font-extralight font-heading text-white uppercase">
            Entre em consenso com seu corpo e mente
          </h1>
          <p className="max-w-xl  text-2xl mt-12 font-light text-white font-body">
